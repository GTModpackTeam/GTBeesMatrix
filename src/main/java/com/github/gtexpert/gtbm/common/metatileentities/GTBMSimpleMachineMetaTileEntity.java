package com.github.gtexpert.gtbm.common.metatileentities;
...
public class GTBMSimpleMachineMetaTileEntity extends SimpleMachineMetaTileEntity {
    ...
    public MetaTileEntity createMetaTileEntity(IGregTechTileEntity tileEntity) {
        return new GTBMSimpleMachineMetaTileEntity(this.metaTileEntityId, workable.getRecipeMap(), this.renderer,
