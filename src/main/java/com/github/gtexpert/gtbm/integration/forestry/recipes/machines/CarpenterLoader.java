...
public class CarpenterLoader {
    ...
    public static void initMode() {
        ...
        if (recipeMode == ForestryUtility.recipeMode.NORMAL) {
            ...
            // Circuit
            CarpenterLoader.registerCarpenterRecipe(recipeMode, Mods.Forestry.getItem("chipsets", 1),
                    20, Materials.Iron, MetaItems.COATED_BOARD, ModUtility.oreDictionaryCircuit(GTValues.ULV));
            CarpenterLoader.registerCarpenterRecipe(recipeMode, Mods.Forestry.getItem("chipsets", 1, 1),
                    40, Materials.Bronze, MetaItems.COATED_BOARD, ModUtility.oreDictionaryCircuit(GTValues.LV));
            CarpenterLoader.registerCarpenterRecipe(recipeMode, Mods.Forestry.getItem("chipsets", 1, 2),
                    80, Materials.Steel, MetaItems.PHENOLIC_BOARD, ModUtility.oreDictionaryCircuit(GTValues.MV));
            CarpenterLoader.registerCarpenterRecipe(recipeMode, Mods.Forestry.getItem("chipsets", 1, 3),
                    160, Materials.Electrum, MetaItems.PHENOLIC_BOARD, ModUtility.oreDictionaryCircuit(GTValues.HV));
        }
    }
